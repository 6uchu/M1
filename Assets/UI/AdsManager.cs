...
public class AdsManager : MonoBehaviour
{
    ...
    private const string AOS_BANNER_TEST_AD_ID = "ca-app-pub-3940256099942544/9257395921";
    private const string IOS_BANNER_TEST_AD_ID = "ca-app-pub-3940256099942544/2934735716";
    private const string AOS_BOTTOM_BANNER_AD_ID = "ca-app-pub-4653577458776515/1015113742";
    ...
    public void EnableBottomBannerAd(bool value)
    {
        if (value)
        {
            if (m_BottomBannerView == null)
            {
                ...
                m_BottomBannerView = new BannerView(m_BottomBannerAdId, adaptiveSize, AdPosition.Top);
...
#if UNITY_ANDROID
    private const string REWARDED_AD_UNIT_ID = "ca-app-pub-4653577458776515/1526937990";
#elif UNITY_IPHONE
